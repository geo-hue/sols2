...
export interface ICertifiedDoctor extends Document {
  _id: string;
  mcdnNumber: string;
  specialty: string;
...
const certifiedDoctorSchema = new Schema<ICertifiedDoctor>(
  {
    _id: {
      type: String,
      default: uuidv4,
...
export default mongoose.model<ICertifiedDoctor>("CertifiedDoctor", certifiedDoctorSchema);