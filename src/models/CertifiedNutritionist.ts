...
export interface ICertifiedNutritionist extends Document {
  _id: string;
...
const certifiedNutritionistSchema = new Schema<ICertifiedNutritionist>(
  {
    _id: {
      type: String,
      default: uuidv4,
...
export default mongoose.model<ICertifiedNutritionist>(
